...
namespace Particles2DPipelineSample
{
    public class ParticleSystem : DrawableGameComponent
    {
        ...
        /// <summary>
        /// Must call before drawing if you wish to change - apply an offset to the
        /// particle system's drawing - in the case of a movable view.
        /// You can choose to use this per particle system to allow some "relative"
        /// and some "absolute" systems
        /// </summary>
        public void ApplyCameraOffsetDelta(Vector2 cameraOffsetDelta, float zoomDelta)
        {
            foreach (Particle p in particles)
            {
                p.Position -= cameraOffsetDelta;
                p.Scale -= zoomDelta;
            }
        }
