...
namespace GameStateManagement
{
    ...
    class LoadingScreen : GameScreen
    {
        ...
        CursorText generatingMapText;
        Texture2D generatingMapTexture;
        bool loadingScreenContentLoaded = false;
                              ...
                              GameScreen[] screensToLoad)
        {
            ...
            //restart cursor text
            loadingScreenContentLoaded = false;
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (loadingScreenContentLoaded)
            {
                generatingMapText.Update(gameTime);
            }
